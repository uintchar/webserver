...
- [5. 进程间通信](#5-进程间通信)
  - [5.1. 信号](#51-信号)
    ...
    - [5.1.2. Linux 信号一览](#512-linux-信号一览)
    - [5.1.3. 信号的 5 种默认处理动作](#513-信号的-5-种默认处理动作)
    - [5.1.4. 信号相关函数](#514-信号相关函数)
    - [5.1.5. 信号捕捉函数](#515-信号捕捉函数)
    - [5.1.6. 信号集](#516-信号集)
    - [5.1.7. 内核实现信号捕捉的过程](#517-内核实现信号捕捉的过程)
    - [5.1.8. 多线程中的信号处理机制](#518-多线程中的信号处理机制)
    - [5.1.9. 应用示例](#519-应用示例)
      - [5.1.9.1. 信号捕捉实现周期性定时器](#5191-信号捕捉实现周期性定时器)
      - [5.1.9.2. 使用SIGCHLD信号解决僵尸进程的问题](#5192-使用sigchld信号解决僵尸进程的问题)
      - [5.1.9.3. 信号集操作函数范例](#5193-信号集操作函数范例)
  - [5.2. 匿名管道](#52-匿名管道)
