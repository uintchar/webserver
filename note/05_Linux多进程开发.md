...
- [4. 终端、会话和守护进程](#4-终端会话和守护进程)
  ...
  - [4.5. 守护进程](#45-守护进程)
    - [4.5.1. 应用示例](#451-应用示例)
      - [4.5.1.1. 每 1s 向磁盘文件打印当前系统时间的守护进程](#4511-每-1s-向磁盘文件打印当前系统时间的守护进程)
- [5. 进程间通信](#5-进程间通信)
  - [5.1. 匿名管道](#51-匿名管道)
  ...
  - [5.3. 内存映射](#53-内存映射)
    ...
    - [5.3.2. 应用示例](#532-应用示例)
  - [5.4. 信号](#54-信号)
    - [5.4.1. 信号的概念](#541-信号的概念)
    - [5.4.2. Linux 信号一览](#542-linux-信号一览)
    - [5.4.3. 信号的 5 种默认处理动作](#543-信号的-5-种默认处理动作)
    - [5.4.4. 信号相关函数](#544-信号相关函数)
    - [5.4.5. 信号捕捉函数](#545-信号捕捉函数)
    - [5.4.6. 信号集](#546-信号集)
    - [5.4.7. 内核实现信号捕捉的过程](#547-内核实现信号捕捉的过程)
    - [5.4.8. 多线程中的信号处理机制](#548-多线程中的信号处理机制)
    - [5.4.9. 应用示例](#549-应用示例)
      - [5.4.9.1. 信号捕捉实现周期性定时器](#5491-信号捕捉实现周期性定时器)
      - [5.4.9.2. 使用SIGCHLD信号解决僵尸进程的问题](#5492-使用sigchld信号解决僵尸进程的问题)
      - [5.4.9.3. 信号集操作函数范例](#5493-信号集操作函数范例)
  - [5.5. 共享内存](#55-共享内存)
...
#### 4.5.1.1. 每 1s 向磁盘文件打印当前系统时间的守护进程
